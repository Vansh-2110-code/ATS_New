...
async function deploy() {
  try {
    ...
    console.log('\n2. Uploading PayslipHubPage.tsx with alignment & close button fix...');
    await ssh.putFile(
      path.join(localBase, 'src/app/pages/payroll/PayslipHubPage.tsx'),
      `${remoteBase}/src/app/pages/payroll/PayslipHubPage.tsx`
    );
    console.log('PayslipHubPage.tsx uploaded successfully.');
    ...
    console.log('\n========================================================');
    console.log('  PAYSLIP MODAL ALIGNMENT & CLOSE BUTTON DEPLOYED LIVE! ');
    console.log('========================================================');
